...
WebDriverWait(driver, 10).until(expected_conditions.presence_of_element_located((By.XPATH, '//*[@id="site-container"]/div/div[2]/form/div[2]/div[3]/button')))
print('found button')
driver.find_element(By.XPATH, '//*[@id="site-container"]/div/div[2]/form/div[2]/div[3]/button').click()
